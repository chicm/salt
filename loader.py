...
def get_train_loaders(ifold, batch_size=8, dev_mode=False, pad_mode='reflect', meta_version=1):
    #pdb.set_trace()
    train_shuffle = True
...
def get_test_loader(batch_size=16, index=0, dev_mode=False, pad_mode='reflect'):
